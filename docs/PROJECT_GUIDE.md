...
### Documentation Files
- `docs/SERVICES_SUMMARY.md` - Services/tools overview (what each service does)
- `docs/BACKEND_SYSTEM_DESIGN.md` - System architecture and design overview
- `docs/BACKEND_SPECIFICATION.md` - Complete backend API specification
- `docs/FIELD_MAPPING_TABLE.md` - Source→target field mapping table
