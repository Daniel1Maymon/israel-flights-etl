...
const translations = {
  en: {
    ...
    'recovery.subtitle': 'Every carrier measured against its own pre-disruption schedule, recalculated on each update',
    ...
    'recovery.bucket.partial.hint': 'Below 90% of their old schedule',
    'recovery.bucket.recovered.hint': '90–125% of their old schedule',
  ...
  he: {
    ...
    'recovery.subtitle': 'כל חברה נמדדת מול הלוח שלה עצמה מלפני המשבר, בחישוב מחדש בכל עדכון',
    ...
    'recovery.bucket.partial.hint': 'מתחת ל-90% מהלוח הקודם',
    'recovery.bucket.recovered.hint': '90%–125% מהלוח הקודם',
